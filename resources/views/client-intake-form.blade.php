                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="dob" name="dob" placeholder="dd/mm/yy" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="pl" id="pl_0" type="checkbox" class="custom-control-input" value="written" required="required">
                                        <label for="pl_0" class="custom-control-label">written</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="pl" id="pl_1" type="checkbox" class="custom-control-input" value="spoken" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="employment status" id="employment status_0" type="checkbox" class="custom-control-input" value="casual" required="required">
                                        <label for="employment status_0" class="custom-control-label">casual</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="employment status" id="employment status_1" type="checkbox" class="custom-control-input" value="contract" required="required">
                                        <label for="employment status_1" class="custom-control-label">contract</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="employment status" id="employment status_2" type="checkbox" class="custom-control-input" value="permanent" required="required">
                                        <label for="employment status_2" class="custom-control-label">permanent</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="employment status" id="employment status_3" type="checkbox" class="custom-control-input" value="unemployed" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select id="vulnerability" name="vulnerability" class="custom-select" aria-describedby="vulnerabilityHelpBlock" required="required" multiple="multiple">
                                        <option value="rabbit">orphaned</option>
                                        <option value="duck">divorced</option>
                                        <option value="fish">child</option>
                                        <option value="">woman</option>
                                        <option value="">physical impairment</option>
                                        <option value="">mental impairment</option>
                            ...
                            <div class="form-group">
                                ...
                                <div style="margin-left: 100px;">
                                    <div class="custom-controls-stacked">
                                        <div class="custom-control custom-checkbox">
                                            <input name="criminal" id="criminal_0" type="checkbox" class="custom-control-input" value="robbery with violence" checked="checked">
                                            <label for="criminal_0" class="custom-control-label">robbery with violence</label>
                                        </div>
                                    </div>
                                    <div class="custom-controls-stacked">
                                        <div class="custom-control custom-checkbox">
                                            <input name="criminal" id="criminal_1" type="checkbox" class="custom-control-input" value="theft" checked="checked">
                                            <label for="criminal_1" class="custom-control-label">theft</label>
                                        </div>
                                    </div>
                                    <div class="custom-controls-stacked">
                                        <div class="custom-control custom-checkbox">
                                            <input name="criminal" id="criminal_2" type="checkbox" class="custom-control-input" value="assault" checked="checked">
                                            <label for="criminal_2" class="custom-control-label">assault</label>
                                        </div>
                                    </div>
                                    <div class="custom-controls-stacked">
                                        <div class="custom-control custom-checkbox">
                                            <input name="criminal" id="criminal_3" type="checkbox" checked="checked" class="custom-control-input" value="domestic violence">
                            ...
                            <div class="form-group">
                                <label for="textarea1">other(please specify)</label>
